package com.magneticraft2.common.systems.multiblock.core.modules;

import com.magneticraft2.common.systems.multiblock.core.IMultiblockModule;
 ...
 * v1.0.0
 */
public class EnergyStorageModule implements IMultiblockModule {
    ...
    public EnergyStorageModule(int capacityW, int maxtransferW) {
    ...
    public IMultiblockModule createModule(Level world, BlockPos pos) {
        return new EnergyStorageModule();
    }
