...
public class FireStarter extends Item {
    ...
    public FireStarter() {
        super(new Properties().stacksTo(1).setNoRepair().tab(FinalRegistry.MC2Items).defaultDurability(5).setNoRepair().durability(5));
    }
    ...
    private void makeEffects(Level world, Player player, double x, double y, double z, int pTimeCharged, int total, Random random)
    {
