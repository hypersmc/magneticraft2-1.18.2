...
public class gbUtils {
    ...
    public static final RegistryObject<Item> FRAMED_HAMMER = RegistryObject.create(
            new ResourceLocation(magneticraft2.MOD_ID, "framed_hammer"),
            ForgeRegistries.ITEMS
    );
    public static final RegistryObject<Item> FRAMED_KEY = RegistryObject.create(
            new ResourceLocation(magneticraft2.MOD_ID, "framed_key"),
            ForgeRegistries.ITEMS
    );
    public static final RegistryObject<Item> FRAMED_SCREWDRIVER = RegistryObject.create(
            new ResourceLocation(magneticraft2.MOD_ID, "framed_screwdriver"),
            ForgeRegistries.ITEMS
    );
    ...
    {
        return new TranslatableComponent(prefix + "." + magneticraft2.MOD_ID + "." + postfix);
    }
    ...
    public static TagKey<Block> blockTag(String name) { return blockTag(magneticraft2.MOD_ID, name); }
    ...
    public static TagKey<Item> itemTag(String name) { return itemTag(magneticraft2.MOD_ID, name); }
